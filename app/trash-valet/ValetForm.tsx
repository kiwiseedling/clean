        ...
        return (
          <div>
            ...
            <div className="space-y-3">
              ...
              {isManager && (
                <>
                  <select value={form.propertyType} onChange={(e) => setForm((f) => ({ ...f, propertyType: e.target.value }))} className={inputCls} style={{ color: form.propertyType ? "rgba(163,217,184,0.9)" : "rgba(255,255,255,0.35)" }}>
      ...
      case 2:
        return (
          <div>
            ...
            {isManager && (
              <select value={form.frequency} onChange={(e) => setForm((f) => ({ ...f, frequency: e.target.value }))} className={`${inputCls} mt-3`} style={{ color: form.frequency ? "rgba(163,217,184,0.9)" : "rgba(255,255,255,0.35)" }}>
        ...
        return (
          <div>
            ...
            <div className="space-y-3">
              ...
              {isManager && (
                <select value={form.timeline} onChange={(e) => setForm((f) => ({ ...f, timeline: e.target.value }))} className={inputCls} style={{ color: form.timeline ? "rgba(163,217,184,0.9)" : "rgba(255,255,255,0.35)" }}>
