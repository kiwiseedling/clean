    ...
    if (booked) {
      return (
        <div style={glass}>
          ...
          <div className="mb-6 text-center text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>
            <p>Price updates as you answer · Locked at booking</p>
            <p className="mt-1">No charge until job is done</p>
          </div>
        ...
        return (
          <div style={glass}>
            ...
            <div className="rounded-xl px-4 py-3" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)" }}>
              ...
              <p className="text-sm italic" style={{ color: "rgba(255,255,255,0.6)" }}>&ldquo;JunkDrive: Your crew is 20 min away. See you soon!&rdquo;</p>
            </div>
          </div>
        );
            ...
            <div className="mb-5 mt-6 space-y-2" style={{ opacity: 0.5 }}>
              <div className="flex justify-start">
                <div className="rounded-2xl rounded-tl-sm px-4 py-3" style={{ background: "rgba(255,255,255,0.07)", maxWidth: "85%" }}>
                  <p className="mb-1 text-[10px] font-bold" style={{ color: accent }}>JunkDrive</p>
