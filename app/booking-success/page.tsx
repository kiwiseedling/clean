...
export default function BookingSuccessPage() {
  ...
  const nextSteps = [
    {
      ...
      body: "Your card is securely on file. We will not charge it until after the job is completed and you've confirmed everything went well.",
    },
    {
      n: "02",
  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden pt-16" style={{ background: "#071912", minHeight: "60vh" }}>
        {/* Background glow */}
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div
            className="absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-20"
            style={{ background: "radial-gradient(circle, rgba(34,118,74,0.5) 0%, transparent 70%)", filter: "blur(80px)" }}
          />
        </div>
        ...
        <div className="relative mx-auto flex max-w-2xl flex-col items-center px-6 py-24 text-center">
          ...
          <div
            ...
            style={{ background: "rgba(34,118,74,0.2)", border: "1px solid rgba(106,191,142,0.3)" }}
          >
          ...
          <h1
            ...
            style={{ color: "white", fontSize: "clamp(2rem,4vw,3rem)", letterSpacing: "-0.03em", lineHeight: 1.05 }}
          >
            You&apos;re all set.
          </h1>
          <p className="mb-6 max-w-md text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.6)" }}>
            Your card is saved and your booking is confirmed. We&apos;ll be in touch to confirm your arrival window.
          </p>
          ...
          <div
            ...
            style={{ background: "rgba(34,118,74,0.15)", border: "1px solid rgba(106,191,142,0.25)" }}
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6abf8e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className="py-16" style={{ background: "#fafafa" }}>
        <div className="mx-auto max-w-5xl px-6">
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              { icon: "shield", label: "Card stored securely", note: "We use Stripe — your full card number is never stored on our servers." },
              { icon: "clock", label: "No charge until you approve", note: "The crew completes the job, then we charge the amount confirmed at booking." },
              { icon: "phone", label: "Questions? Call or text", note: "(713) 282-2588 — we answer fast." },
            ].map(({ label, note, icon }) => (
