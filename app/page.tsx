    ...
    <section className="relative overflow-hidden pt-16" style={{ minHeight: "100vh", background: "#0a1f14" }}>
      ...
      <div className="pointer-events-none absolute inset-0 select-none overflow-hidden">
        ...
        >
          ...
          {/* ── Street / ground ── */}
          <rect x="0" y="720" width="1440" height="180" fill="rgba(15,45,31,0.97)" />
          ...
          {[340, 510, 670].map((cx) => (
            <g key={cx}>
              <circle cx={cx} cy="730" r="36" fill="rgba(18,52,35,0.95)" />
          ...
          <rect    x="896" y="718" width="8" height="50" fill="rgba(10,31,20,0.5)" />
          <ellipse cx="950" cy="665" rx="28" ry="58" fill="rgba(34,118,74,0.22)" />
          <rect    x="947" y="720" width="6" height="40" fill="rgba(10,31,20,0.45)" />
          <ellipse cx="990" cy="655" rx="32" ry="66" fill="rgba(34,118,74,0.25)" />
          <rect    x="987" y="719" width="6" height="46" fill="rgba(10,31,20,0.45)" />
    ...
    <section className="py-24" style={{ background: "#fafafa" }}>
      <div className="mx-auto max-w-5xl px-5">
        <div className="mb-12 max-w-2xl">
          <p className="mb-3 text-xs font-bold uppercase tracking-widest" style={{ color: "#22764a" }}>Why JunkDrive</p>
