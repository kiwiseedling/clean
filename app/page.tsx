    ...
    <section className="relative overflow-hidden pt-16" style={{ minHeight: "100vh", background: "#1a1a1a" }}>
      ...
      <div className="pointer-events-none absolute inset-0 select-none overflow-hidden">
        ...
        >
          ...
          {/* Subtle moon glow */}
          <circle cx="1280" cy="130" r="90" fill="rgba(180,180,180,0.04)" />
          ...
          {[
            ...
            <rect key={idx} x={x} y={y} width="14" height="18" rx="2"
              fill={`rgba(180,180,180,${0.06 + (idx % 4) * 0.04})`} />
          ))}
          ...
          {/* ── Garbage truck ── */}
          {/* Cab */}
          <rect x="280" y="568" width="155" height="152" fill="rgba(70,70,70,0.6)"  rx="12" />
          {/* Cab windshield */}
          <rect x="298" y="582" width="70"  height="52"  fill="rgba(180,180,180,0.18)" rx="6" />
          {/* Cab side window */}
          ...
          {/* Truck body (hopper) */}
          <rect x="430" y="545" width="340" height="175" fill="rgba(70,70,70,0.5)"  rx="8" />
          {/* Hopper top lip */}
          <rect x="620" y="522" width="150" height="35"  fill="rgba(70,70,70,0.6)"  rx="6" />
          {/* Panel seams */}
          ...
          {/* ── Trash bins (curbside) ── */}
          {/* Bin 1 – general */}
          <rect x="1060" y="645" width="46" height="70" fill="rgba(70,70,70,0.45)"  rx="5" />
          <rect x="1055" y="636" width="56" height="14" fill="rgba(70,70,70,0.55)"  rx="4" />
          <rect x="1068" y="656" width="30" height="4"  fill="rgba(180,180,180,0.2)" rx="2" />
          {/* Bin 2 – recycling */}
          <rect x="1118" y="640" width="50" height="75" fill="rgba(100,100,100,0.4)"  rx="5" />
          <rect x="1113" y="631" width="60" height="14" fill="rgba(100,100,100,0.5)"  rx="4" />
          <rect x="1126" y="651" width="34" height="4"  fill="rgba(180,180,180,0.18)" rx="2" />
          {/* Bin 3 – organics */}
          <rect x="1180" y="650" width="42" height="65" fill="rgba(55,55,55,0.4)"   rx="5" />
          <rect x="1175" y="641" width="52" height="13" fill="rgba(55,55,55,0.5)"   rx="4" />

          {/* ── Resident silhouette ── */}
          <ellipse cx="1145" cy="600" rx="14" ry="14" fill="rgba(180,180,180,0.2)" />
          <rect x="1137" y="614" width="16" height="34" fill="rgba(180,180,180,0.18)" rx="5" />
          <rect x="1124" y="620" width="13" height="4"  fill="rgba(180,180,180,0.15)" rx="2" />
          <rect x="1150" y="618" width="13" height="4"  fill="rgba(180,180,180,0.15)" rx="2" />
          <rect x="1137" y="648" width="6"  height="24" fill="rgba(180,180,180,0.12)" rx="2" />
          <rect x="1146" y="648" width="6"  height="24" fill="rgba(180,180,180,0.12)" rx="2" />
        </svg>
        ...
        <div className="rounded-[28px] bg-white p-7 card-shadow-xl">
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm text-gray-800 outline-none transition-colors focus:border-gray-400"
            />
            <input
              type="email"
              autoComplete="email"
  ...
  return (
    <section id="services" className="py-24 bg-white">
      <div className="mx-auto max-w-6xl px-6">
        ...
        {/* 01 Bulk Waste */}
        <div className="mb-4 grid gap-0 overflow-hidden rounded-[32px] lg:grid-cols-2" style={{ border: "1px solid #e5e5e5" }}>
        ...
        {/* 02 Trash Valet */}
        <div className="grid gap-0 overflow-hidden rounded-[32px] lg:grid-cols-2" style={{ border: "1px solid #e2e2e2" }}>
          {/* Left: title + description + who */}
          <div className="flex flex-col justify-between p-8 md:p-10" style={{ background: "#f5f5f5" }}>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-between gap-4 border-t pt-6" style={{ borderColor: "#e2e2e2" }}>
              <div className="flex gap-8">
    ...
    <section style={{ background: "#1a1a1a" }}>
      <div className="mx-auto max-w-6xl px-6 py-20">
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
          ...
          <div className="space-y-0 divide-y" style={{ borderColor: "rgba(180,180,180,0.12)" }}>
            {[
              {
                num: "01",
                label: "Donate",
              ...
              <div key={item.label} className="flex items-start gap-5 py-6">
                <span className="min-w-[2.5rem] text-xs font-bold tabular-nums" style={{ color: "rgba(180,180,180,0.4)" }}>{item.num}</span>
                <div>
      ...
      <div className="mx-auto max-w-5xl px-5">
        <div className="mb-12 max-w-2xl">
          ...
          <p className="leading-relaxed text-gray-500">
            We built JunkDrive around the things people actually care about: knowing what they&apos;ll pay, having someone show up on time, and not dealing with a process that wastes their day.
          </p>
        </div>
